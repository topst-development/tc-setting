...
/*---------------------------------------------------------------------------------------------------------------------
    Balance fade module
  ---------------------------------------------------------------------------------------------------------------------*/
#define ZIRENE_BALANCEFADE_BALANCE_IN_PPT_MIN         (-1000)    /**< Minimum supported balance level in parts-per-thousand  */
#define ZIRENE_BALANCEFADE_BALANCE_IN_PPT_MAX         1000       /**< Maximum supported balance level in parts-per-thousand  */
#define ZIRENE_BALANCEFADE_BALANCE_IN_PPT_DEFAULT     0          /**< Default balance value in parts-per-thousand            */

#define ZIRENE_BALANCEFADE_FADE_IN_PPT_MIN            (-1000)    /**< Minimum supported balance level in parts-per-thousand  */
#define ZIRENE_BALANCEFADE_FADE_IN_PPT_MAX            1000       /**< Maximum supported balance level in parts-per-thousand  */
#define ZIRENE_BALANCEFADE_FADE_IN_PPT_DEFAULT        0          /**< Default balance value in parts-per-thousand            */
...
typedef enum 
{
    /** Enables or disables the BalanceFade effect. iValue sets the effect to enabled (::AM3D_TRUE) or disabled (::AM3D_FALSE). 
     * Default the effect is disabled (::AM3D_FALSE). */
    ...
    /** Sets the desired balancing level (left/right pan) in parts-per-thousand. */
    ZIRENE_BALANCEFADE_BALANCE_IN_PPT,
    /** Sets the desired fade level (back/front pan) in parts-per-thousand. */
    ZIRENE_BALANCEFADE_FADE_IN_PPT
