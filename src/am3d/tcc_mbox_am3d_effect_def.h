...
/* unsigned int cmd[4] = effect handle index (Example: EFFECT_FOR_MEDIA:effect for main media, EFFECT_FOR_SUB:effect for rse) */
/* unsigned int cmd[5] = value to set , if using MBOX_AUDIO_USAGE_REQUEST, do not use it */
...
/* unsigned int cmd[4] = effect handle index (for example: 0:effect for main media, 1:effect for rse) */
/* unsigned int cmd[5] = value to set (0 = off or 1 = on), if using MBOX_AUDIO_USAGE_REQUEST, do not use it */
/*                       reply value is set here */
...
#define AUDIO_MBOX_EFFECT_GET_MESSAGE_SIZE        4
#define AUDIO_MBOX_EFFECT_SET_MESSAGE_SIZE        5
...
//Distinguish effect usage
enum effect_handle_index {
    EFFECT_FOR_MEDIA = 0             ,
    EFFECT_FOR_SUB   = 1             ,
};
